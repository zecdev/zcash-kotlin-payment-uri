...
import org.zecdev.zcash.zip321.parser.Parser
...
object ZIP321 {
    ...
    fun uriString(
        ...
        return when (formattingOptions) {
            is FormattingOptions.EnumerateAllPayments -> org.zecdev.zcash.zip321.Render.request(from, 1u, false)
            is FormattingOptions.UseEmptyParamIndex -> org.zecdev.zcash.zip321.Render.request(
                from,
                startIndex = null,
    ...
    fun request(
        ...
        return when (formattingOptions) {
            is FormattingOptions.UseEmptyParamIndex -> "zcash:".plus(
                org.zecdev.zcash.zip321.Render.parameter(recipient, index = null, omittingAddressLabel = formattingOptions.omitAddressLabel)
            )
            else -> "zcash:".plus(org.zecdev.zcash.zip321.Render.parameter(recipient, index = null, omittingAddressLabel = false))
        }
    }
